...
**Note*:**
- When using eWeLink-Remote Gateway Add-on, you need to ensure that the Bluetooth function of Home Assistant can be used normally (the Bluetooth module is normal), otherwise the prompt content in the picture will appear
